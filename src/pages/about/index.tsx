...
function ValueCard(props: {
  ...
  return (
    ...
    >
      <p className="text-center text-[28px] leading-[34px] font-normal tracking-[0.38px] text-white">
        {title}
      </p>
      <p className="w-full max-w-[486px] text-center text-[17px] leading-[22px] font-normal tracking-[-0.43px] text-[#c7c7cc]">
        {description}
      </p>
    ...
    <main className="py-24 text-white">
      <div className={PAGE_CONTAINER_CLASS}>
        <section className="flex flex-col items-center py-10 text-center">
          ...
          <h1 className="mt-12 text-center text-[34px] leading-[41px] font-bold tracking-[0.4px]">
            <span className="text-[#2e4ecf]">Краткая </span>
            <span className="text-white">история</span>
          </h1>

          <div className="mt-8 flex w-full max-w-[800px] flex-col gap-6 text-[20px] leading-7 font-normal tracking-[-0.4px] text-white">
            <p>
        ...
        <section className="py-16">
          <div className="flex flex-col items-center gap-3 text-center">
            <h2 className="min-w-full text-center text-[34px] leading-[41px] font-bold tracking-[0.4px]">
              <span className="text-[#2e4ecf]">Миссия и </span>
              <span className="text-white">ценности</span>
            </h2>
            <p className="w-full max-w-[800px] text-[22px] leading-7 font-normal tracking-[-0.26px] text-white">
          ...
          <div className="relative mx-auto mt-14 w-full max-w-[1878px]">
            <div className="grid justify-items-center gap-10 xl:block xl:min-h-[1032px]">
              <ValueCard
                ...
                className="xl:absolute xl:top-[153px] xl:left-[103px]"
              ...
              <ValueCard
                ...
                className="xl:absolute xl:top-[228px] xl:left-[1244px]"
              ...
              <ValueCard
                ...
                className="xl:absolute xl:top-[682px] xl:left-[250px]"
              ...
              <ValueCard
                ...
                description="Мы работаем только с квалифицированными экспертами и применяем современные методики исследования."
                className="xl:absolute xl:top-[781px] xl:left-[1069px]"
        ...
        <section className="py-16">
          ...
          <div className="mt-12 grid gap-8 md:grid-cols-2 lg:grid-cols-3">
            <div className={cn('flex flex-col gap-4 p-6', GLASS_CARD_CLASS)}>
              ...
              <p className="text-[17px] leading-[22px] text-[#c7c7cc]">
            ...
            <div className={cn('flex flex-col gap-4 p-6', GLASS_CARD_CLASS)}>
              ...
              <p className="text-[17px] leading-[22px] text-[#c7c7cc]">
                Все эксперты прошли аттестацию и имеют квалификационные
                сертификаты
              </p>
            </div>
          </div>
        ...
        <section className="py-16">
          <div className="flex flex-col items-center gap-3 text-center">
            ...
            <p className="w-full max-w-[800px] text-[22px] leading-7 font-normal tracking-[-0.26px] text-white">
              АНСЭ активно сотрудничает с международными экспертными
              организациями и участвует в обмене опытом с ведущими специалистами
              из разных стран.
            </p>
          </div>
          ...
          <div className="mt-12 grid gap-8 md:grid-cols-2">
            ...
            <div className={cn('flex flex-col gap-4 p-6', GLASS_CARD_CLASS)}>
              ...
              <p className="text-[17px] leading-[22px] text-[#c7c7cc]">
                Эксперты АНСЭ регулярно выступают на международных форумах и
                делятся своими наработками с коллегами.
              </p>
            </div>
        ...
        <section className="py-16">
          ...
          <div className="mt-12 grid gap-8 md:grid-cols-2">
            ...
            <div className={cn('flex flex-col gap-4 p-6', GLASS_CARD_CLASS)}>
              ...
              <p className="text-[17px] leading-[22px] text-[#c7c7cc]">
                АНСЭ проводит семинары, вебинары и курсы повышения квалификации
                для юристов, адвокатов и сотрудников правоохранительных органов.
              </p>
            </div>
            ...
            <div className={cn('flex flex-col gap-4 p-6', GLASS_CARD_CLASS)}>
              ...
              <p className="text-[17px] leading-[22px] text-[#c7c7cc]">
                Эксперты АНСЭ участвуют в разработке новых методик исследований
                и публикуют статьи в научных изданиях.
              </p>
            </div>
            ...
            <div className={cn('flex flex-col gap-4 p-6', GLASS_CARD_CLASS)}>
              ...
              <p className="text-[17px] leading-[22px] text-[#c7c7cc]">
                АНСЭ проводит открытые лекции и мероприятия для повышения
                правовой грамотности граждан и понимания роли судебных
                экспертиз.
              </p>
            </div>
          </div>

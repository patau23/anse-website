...
export function AboutLicensesSection() {
  ...
  const items: Array<{ title: string; description: string }> = t('about.licenses.items', { returnObjects: true });

  return (
    <section className="py-16">
      <div className="flex flex-col items-center gap-3 text-center">
        <h2 className="min-w-full text-center text-[34px] leading-10.25 font-bold tracking-[0.4px]">
          <span className="text-[#2e4ecf]">{t('about.licenses.titlePrefix')}</span>
